...
function custom_submit_job_form_fields( $fields ) {
	...
	//get the minimum guests
		$fields['job']['min_guest'] = array(
		'label' => 'Guests Min',
		'type' => 'select',
		'options' => $min_arr,
		'required' => true,
